...
//                   required="required"
//                   ref={email}
//                   className="border-b  border-primary-300 py-1 focus:border-b-2 focus:border-primary-700 transition-colors focus:outline-none peer bg-inherit"
//                 />
//                 <label
//                   for="username"
...
//           <Link to="/register" className='text-lightgrey hover:text-blue-500'>Don't have an account?Register</Link><br /><br />
...
//                 type='submit'
//                 disabled={isLoading}
//                 className='bg-gradient-to-r from-secondary to-primary w-60 h-14 text-white font-bold py-2 px-4 rounded text-center'
//               >
//                 <b>{isLoading ? 'Logging In...' : 'Login'}</b>
//               </button>
//               <br />
//               <Link to='/register' className='text-lightgrey hover:text-blue-500'>
